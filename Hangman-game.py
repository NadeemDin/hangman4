...
class Hangman:
    ...
    def select_difficulty(self):
        #Difficulty selection alters number of lives 
        while True:
            difficulty = input("\nSelect difficulty (easy/hard): ").lower()
            if difficulty in ['easy', 'hard']:
                return difficulty
            else:
                print("Invalid difficulty. Please choose either 'easy' or 'hard.'")
...
def play_game(word_list):
    ...
    num_lives = 6 if difficulty == 'easy' else 3 
    game.num_lives = num_lives
    print(f"\nYou have {num_lives} lives, Good Luck!\n")
    print(f"\n{game.word_guessed}\n")
